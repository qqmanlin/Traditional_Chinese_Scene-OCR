...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/chinese_ocr.cfg', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/chinese_ocr.yaml', help='data.yaml path')
    ...
    parser.add_argument('--name', default='ocr', help='save to project/name')
